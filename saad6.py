...
vdc=400*10**4
'''
p=1 #le parametre qu'on veut visualiser son influence sur l'efficacité
'''
tp=150
eps=8.85*10**(-12)
cd=10,1
...
xlabel('pression')
ylabel("l'efficacité")
title("l'efficacité en fonction de la pression")
legend()
grid()
show()